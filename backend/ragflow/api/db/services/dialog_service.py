...
from ragflow.api.db.db_models import DB, Dialog
...
from ragflow.api.db.services.langfuse_service import TenantLangfuseService
...
from ragflow.graphrag.general.mind_map_extractor import MindMapExtractor
...
from ragflow.rag.prompts import (
    chunks_format,
    citation_prompt,
    cross_languages,
    full_question,
...
from ragflow.rag.prompts.prompts import ASK_SUMMARY, PROMPT_JINJA_ENV, gen_meta_filter
...
class DialogService(CommonService):
    ...
    def get_by_tenant_ids(cls, joined_tenant_ids, user_id, page_number, items_per_page, orderby, desc, keywords, parser_id=None):
        from ragflow.api.db.db_models import User
