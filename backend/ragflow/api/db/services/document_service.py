...
from ragflow.rag.settings import SVR_CONSUMER_GROUP_NAME, get_svr_queue_name
...
def doc_upload_and_parse(conversation_id, file_objs, user_id):
    ...
    from ragflow.api.db.services.conversation_service import ConversationService
    ...
    from ragflow.rag.app import audio, email, naive, picture, presentation
